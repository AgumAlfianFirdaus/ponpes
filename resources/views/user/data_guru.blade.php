                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Kelas Tajwid-Bacaan</i></h4>
                            <div class="left col-xs-7">
                              <h2>Ust Wreda Alfin P</h2>
                              <ul class="list-unstyled">
                                <li><i class="fa fa-mortar-board"></i>Education: SMA BudiUtomo</li>
                                <li><i class="fa fa-building"></i>Address:Jakarta Timur </li>
                                <li><i class="fa fa-phone"></i>Phone #:0123456789 </li>
                              </ul>
                            </div>
                            <div class="right col-xs-5 text-center">
                              <img src="img/bacaan.jpg" alt="" class="img-circle img-responsive">
                            </div>
                          </div>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Kelas Pegon-Bacaan </i></h4>
                            <div class="left col-xs-7">
                              <h2>Ust H.Fathun Qorib </h2>
                              <ul class="list-unstyled">
                                <li><i class="fa fa-mortar-board"></i>Education: SMA</li>
                                <li><i class="fa fa-building"></i>Address:Al-Kautsar 1 </li>
                                <li><i class="fa fa-phone"></i>Phone #:0123456789 </li>
                              </ul>
                            </div>
                            <div class="right col-xs-5 text-center">
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Kelas Lambatan Putra</i></h4>
                            <div class="left col-xs-7">
                              <h2>Ust Saddam</h2>
                               <ul class="list-unstyled">
                                <li><i class="fa fa-mortar-board"></i>Education: IAIN Syekh Nurjati</li>
                                <li><i class="fa fa-building"></i>Address:Al-Kautsar 1 </li>
                                <li><i class="fa fa-phone"></i>Phone #:0123456789 </li>
                              </ul>
                            </div>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Kelas Lambatan Putri</i></h4>
                            <div class="left col-xs-7">
                              <h2>Ust Amirudin</h2>
                              <ul class="list-unstyled">
                                <li><i class="fa fa-mortar-board"></i>Education: SMA </li>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Kelas Cepatan Putri</i></h4>
                            <div class="left col-xs-7">
                              <h2>Ust Hadi Mutholib</h2>
                             <ul class="list-unstyled">
                                <li><i class="fa fa-mortar-board"></i>Education: SMA </li>
                                <li><i class="fa fa-building"></i>Address:Al-Kautsar 1 </li>
                                <li><i class="fa fa-phone"></i>Phone #:0123456789 </li>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Kelas Cepatan Putra</i></h4>
                            <div class="left col-xs-7">
                              <h2>Ust Bima</h2>
                              <ul class="list-unstyled">
                                <li><i class="fa fa-mortar-board"></i>Education: SMA BudiUtomo </li>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            <h4 class="brief"><i>Kelas Saringan</i></h4>
                            <div class="left col-xs-7">
                              <h2>Ust H Nurhasan</h2>
                              <ul class="list-unstyled">
                                <li><i class="fa fa-mortar-board"></i>Education: Stiba Invada </li>
                                <li><i class="fa fa-building"></i>Address:Al-Kautsar 1 </li>
                                <li><i class="fa fa-phone"></i>Phone #:0123456789 </li>
                              </ul>
                            </div>
