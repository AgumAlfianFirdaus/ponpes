                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form" method="post" action="{{url('/user-process')}}" data-parsley-validate>
                      ...
                      <input type="text" id="fullname" class="form-control" name="username" value="{{$login->username}}" required />

                      <label for="email">Email:</label>
                      <input type="email" id="email" class="form-control" name="email" value="{{$login->email}}" data-parsley-trigger="change" required />

					            <label for="heard">Hak Akses:</label>
					   ...
					   <label for="heard">Activation Status</label>
